  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-6">
      ...
      <div className="relative w-full max-w-md">
        <div className="relative">
          <Input
            ...
            disabled={isLoading}
          />
          <span className="absolute right-3 top-1/2 -translate-y-1/2 text-robot-accent animate-blink">
            _
          </span>
        </div>
      ...
      <Button
        ...
        disabled={isLoading}
        className="bg-robot-accent text-robot-dark hover:bg-robot-accent/80 mt-4 px-8 disabled:opacity-50"
      >
        {isLoading ? "STARTING GAME..." : "CONFIRM"}
      </Button>
    </div>
  );
};
